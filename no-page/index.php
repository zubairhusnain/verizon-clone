...
<html lang="en">
  <head>
    ...
    <title>Page Not Found | Verizon</title>
      ...
      h1{font-size:2rem;margin-bottom:0.5rem;color:#cd040b}
                                                      ...
                                                      <div class="box">
                                                        <h1>Page Not Found</h1>
                                                          <p>Sorry, this page is not available in the offline mirror.</p>
                                                            <p>
                                                              <a href="<?php echo htmlspecialchars(VZ_BASE_URL . '/', ENT_QUOTES, 'UTF-8'); ?>">Return to homepage</a>
                                                              </p>
                                                              <?php if (!empty($_GET['from'])): ?>
                                                              <p style="opacity:0.6;font-size:0.85rem">Requested: <?php echo htmlspecialchars((string)$_GET['from'], ENT_QUOTES, 'UTF-8'); ?>
                                                              </p>
                                                              <?php endif; ?>
                                                            </div>
                                                            <footer id="vz-gf20">
