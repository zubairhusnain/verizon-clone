...
<html lang="en">
  <head>
    ...
    <style id="offline-layout-fixes">main{display:block!important;min-height:40vh;}#__next,main{position:relative;z-index:1;}</style>
    ...
    <link rel="preload" as="script" fetchpriority="low" href="assets/www.verizon.com/about/nextgen/_next/static/chunks/webpack-c3c7edc60cc1fe60.js">
    ...
    <link rel="preload" as="script" href="/about/our-company/open-internet/vz/xdi.js">
    <title>Open Internet | About Verizon</title>
      <meta name="robots" content="index, follow">
      <link rel="canonical" href="/about/our-company/open-internet/about/our-company/open-internet/">
      <meta property="og:title" content="Open Internet | About Verizon">
      ...
      <meta name="twitter:title" content="Open Internet | About Verizon">
      <link rel="icon" href="favicon.ico" type="image/x-icon" sizes="16x16">
      <link rel="stylesheet" href="/about/our-company/open-internet/assets/www.verizon.com/etc/designs/vzwcom/gnav20/core.css">
      <script>var gnavdl = {"bu":"corporate","appid":"corpweb","impltype":"ssi","options":{"sticky":"true"}};</script>
      <script type="text/javascript" src="/about/our-company/open-internet/assets/www.verizon.com/etc/designs/vzwcom/gnav20/corporate.js"></script>
    </head>
    <body style="margin:0">
      <header id="vz-gh20">
                                ...
                                <div class="gnav20-grid1-wrapper">
                                  <div class="gnav20-logo">
                                    <div class="gnav20-logo-wrapper gnav20-relative-index">
                                      <a class="gnav20-logoWhiteBg" title="About Verizon" href="/about/our-company/open-internet/about/">
                                      </a>
                                    </div>
                                  </div>
                                </div>
                                        ...
                                        <nav id="gnav20-mobile-menu" class="gnav20-mobile-menu gnav20-hide">
                                          <button id="gnav20-closex" class="gnav20-closex" aria-label="close the Menu" tabindex="0">Close</button>
                                            <div id="gnav20-ulwrapper">
                                              <a id="gnav20-eyebrow-link-About-Us-mobile" href="/about/our-company/open-internet/about/" data-label="About Us" aria-label="Verizon About Us Services HomePage" class="gnav20-main-header gnav20-selected">About Us</a>
                      ...
                      <main>
                              ...
                              <div class="announcement-bar_inlineContent__D9aTW">
                                <p class="VDS__MON__text-module__x-eQN VDS__MON__text-module__f0TWM VDS__MON__text-module__HzJDd" style="--base-text-color: var(--vds-color-element-primary-ondarkbrandhighlight);">
                                  <span class="rich-text_wrapper__C_mKL rich-text_backgroundColor-darkbrandhighlight__0_xzW">
                                    <span style="white-space: pre-wrap;">Get email updates with the latest stories, insights, and news from Verizon. <a class="VDS__MON__text-link-module__Cq8Mx VDS__MON__text-link-module__pKypF VDS__MON__text-link-module__i1Yk6" href="/about/our-company/open-internet/about/news/news-alert-signup/" role="link" aria-label="Sign up for Verizon News Alerts" data-testid="text-link" tabindex="0">
                        ...
                        <div style="background:var(--vds-color-surface-undefined)" class="app_mainWrapper__12DSR">
                          <div class="base-block_container__ZFzh0 base-block_lightprimary__TA3S7" style="width:100%">
                            ...
                            <div class="base-block_contentWrapper__5oAUk " style="--padding-top-mobile:var(--vds-space-4x);--padding-bottom-mobile:4px;--padding-top-tablet:var(--vds-space-6x);--padding-bottom-tablet:4px;--padding-top-desktop:var(--vds-space-6x);--padding-bottom-desktop:4px;--desktop-content-max-width:1232px">
                              <div class="breadcrumb-header_breadcrumbContainer__IQNSf">
                                <div class="breadcrumb-header_breadcrumbWrapper__3QCTC">
                                  <div class="breadcrumb-header_breadcrumbItems__eOJ6u ">
                                    <nav class="VDS__MON__breadcrumbs-module__b2cNB VDS__MON__breadcrumbs-module__47Tou" aria-label="">
                                      <ol>
                                        <li>
                                          <a aria-label="" role="link" tabindex="0" href="/about/" data-testid="breadcrumb-item-link">About</a>
                                            <span aria-hidden="true">/</span>
                                            </li>
                                            <li class="VDS__MON__breadcrumbs-module__NPI--">
                                              <a href="" aria-label="" role="link" tabindex="0" data-testid="breadcrumb-item-link" aria-current="page">Open internet</a>
                                              </li>
                                            </ol>
                                          </nav>
                                        </div>
                                ...
                                <div class="app_main__Wyppx">
                                  <div class="base-block_container__ZFzh0 base-block_lightprimary__TA3S7" id="6904b0cf7c099040ae96aa28" style="width:100%">
                                    <a id="base-block-hidden-anchor-6904b0cf7c099040ae96aa28" tabindex="-1">
                                    </a>
                                    <div class="base-block_contentWrapper__5oAUk " style="--padding-top-mobile:var(--vds-space-12x);--padding-bottom-mobile:var(--vds-space-12x);--padding-top-tablet:var(--vds-space-16x);--padding-bottom-tablet:var(--vds-space-16x);--padding-top-desktop:var(--vds-space-24x);--padding-bottom-desktop:var(--vds-space-24x);--desktop-content-max-width:1232px">
                                      <div style="width:100%" class="header-title_outerWrapper___kDOM">
                                        <div class="header-title_textWrapper__MjGg7" style="--header-textHorizontalAlignment:center;--header-align-items:center">
                                          <div class="header-title_eyebrow__9T_6O" style="--header-eyebrow-maxWidth-mobile:328px;--header-eyebrow-maxWidth-tablet:720px;--header-eyebrow-maxWidth-desktop:976px;--header-eyebrow-maxWidth:100%">
                                            ...
                                            <div class="header-title_title__zNZnw" style="--header-title-maxWidth-mobile:328px;--header-title-maxWidth-tablet:720px;--header-title-maxWidth-desktop:976px;--header-title-maxWidth:100%">
                                              <h1 style="--base-text-color:var(--vds-color-element-primary-onlightprimary);--tablet-fontfamily:var(--vds-typography-title-xlarge-fontfamily);--tablet-fontsize:var(--vds-typography-title-xlarge-fontsize);--tablet-fontweight:var(--vds-typography-title-xlarge-fontweight-bold);--tablet-lineheight:var(--vds-typography-title-xlarge-lineheight);--tablet-letterspacing:var(--vds-typography-title-xlarge-letterspacing-bold);--tablet-color:var(--vds-color-element-primary-onlightprimary);--desktop-fontfamily:var(--vds-typography-title-2xlarge-fontfamily);--desktop-fontsize:var(--vds-typography-title-2xlarge-fontsize);--desktop-fontweight:var(--vds-typography-title-2xlarge-fontweight-bold);--desktop-lineheight:var(--vds-typography-title-2xlarge-lineheight);--desktop-letterspacing:var(--vds-typography-title-2xlarge-letterspacing-bold);--desktop-color:var(--vds-color-element-primary-onlightprimary);--mobile-fontfamily:var(--vds-typography-title-medium-fontfamily);--mobile-fontsize:var(--vds-typography-title-medium-fontsize);--mobile-fontweight:var(--vds-typography-title-medium-fontweight-bold);--mobile-lineheight:var(--vds-typography-title-medium-lineheight);--mobile-letterspacing:var(--vds-typography-title-medium-letterspacing-bold);--mobile-color:var(--vds-color-element-primary-onlightprimary)" class="VDS__MON__text-module__x-eQN VDS__MON__text-module__cYsoT VDS__MON__text-module__Eo6jM VDS__MON__text-module__lEJk4 VDS__MON__text-module__Npe1j VDS__MON__text-module__kmxF6 VDS__MON__text-module__Npe1j VDS__MON__text-module__3QgCx VDS__MON__text-module__Npe1j VDS__MON__text-module__hZ-lB">Access, speed,
                                                fair handling, clear information
                                                and quality of service</h1>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="base-block_container__ZFzh0 base-block_lightprimary__TA3S7" style="width:100%" aria-hidden="false">
                                        <a id="base-block-hidden-anchor-undefined" tabindex="-1">
                                        </a>
                                        <div class="base-block_contentWrapper__5oAUk hero-block_heroSectionWrapper__9B4xE" style="--padding-left-tablet:0px;--padding-right-tablet:0px;--padding-left-mobile:0px;--padding-right-mobile:0px;--desktop-content-max-width:1232px">
                                          <div class="hero-block_heroWrapper__ZIeUh hero-block_inline__yJhY6 hero-block_desktopSmallBorderRadius__T0_40" style="--desktop-large-fixed-border-radius:var(--vds-tiles-border-radius-hero);--mobile-aspect-ratio-override:16/9;--tablet-aspect-ratio-override:21/9" id="hero-wrapper">
                                            <div class="hero_container__Mv1Qr" style="--hero-height:100%">
                                              <div style="aspect-ratio:21/9;height:100%" class="hero_imageWrapper__N6Q30">
                                                <div class="image_imageContainer__3nvQM" style="height:100%;aspect-ratio:21/9">
                                                  <picture>
                                                    <source type="image/webp" srcset="assets/ss7.vzw.com/is/image/VerizonWireless/OI%20hero?resMode=sharp2&amp;scl=1&amp;fmt=webp">
                                                    <source type="image/avif" srcset="assets/ss7.vzw.com/is/image/VerizonWireless/OI%20hero?resMode=sharp2&amp;scl=1&amp;fmt=avif">
                                                    <img class="image_image__sPkwR " src="assets/ss7.vzw.com/is/image/VerizonWireless/OI%20hero/?resMode=sharp2&amp;scl=1" alt="A man wearing headphones leans over a table in a home kitchen to work on a tablet.">
                                                  </picture>
                                                </div>
                                              </div>
                                      ...
                                      <div class="base-block_container__ZFzh0 base-block_lightprimary__TA3S7" id="6908af9a8cc9adb711808322" style="width:100%" data-scrollable-id="vz-about-accordion-disabled-scroll-into-view">
                                        <a id="base-block-hidden-anchor-6908af9a8cc9adb711808322" tabindex="-1">
                                        </a>
                                        <div class="base-block_contentWrapper__5oAUk " style="--padding-top-mobile:var(--vds-space-12x);--padding-bottom-mobile:var(--vds-space-8x);--padding-top-tablet:var(--vds-space-16x);--padding-bottom-tablet:var(--vds-space-12x);--padding-top-desktop:var(--vds-space-24x);--padding-bottom-desktop:var(--vds-space-16x);--desktop-content-max-width:1232px">
                                          <div class="rich-text-block_outerWrapper__OJcf3" style="--content-horizontalAlignment-mobile:center;--content-horizontalAlignment-tablet:center;--content-horizontalAlignment-desktop:center">
                                            <div class="rich-text-block_customizedWrapper__s_fkv" style="--content-maxWidth-mobile:328px;--content-maxWidth-tablet:550px;--content-maxWidth-desktop:688px;--content-gap-mobile:32px;--content-gap-tablet:48px;--content-gap-desktop:48px">
                                              <div style="width:100%" class="header-title_outerWrapper___kDOM">
                                                <div class="header-title_textWrapper__MjGg7" style="--header-textHorizontalAlignment-mobile:center;--header-align-items-mobile:center;--header-textHorizontalAlignment-tablet:center;--header-align-items-tablet:center;--header-textHorizontalAlignment-desktop:center;--header-align-items-desktop:center;--header-textHorizontalAlignment:left;--header-align-items:flex-start">
                                                  <div class="header-title_subtitle__ym7Pb" style="--header-subtitle-maxWidth-mobile:328px;--header-subtitle-maxWidth-tablet:550px;--header-subtitle-maxWidth-desktop:688px;--header-subtitle-maxWidth:100%">
                                                    <span style="--base-text-color:var(--vds-color-element-primary-onlightprimary);--desktop-fontfamily:var(--vds-typography-title-small-fontfamily);--desktop-fontsize:var(--vds-typography-title-small-fontsize);--desktop-fontweight:var(--vds-typography-title-small-fontweight-regular);--desktop-lineheight:var(--vds-typography-title-small-lineheight);--desktop-letterspacing:var(--vds-typography-title-small-letterspacing-regular);--desktop-color:var(--vds-color-element-primary-onlightprimary);--mobile-fontfamily:var(--vds-typography-title-xsmall-fontfamily);--mobile-fontsize:var(--vds-typography-title-xsmall-fontsize);--mobile-fontweight:var(--vds-typography-title-xsmall-fontweight-regular);--mobile-lineheight:var(--vds-typography-title-xsmall-lineheight);--mobile-letterspacing:var(--vds-typography-title-xsmall-letterspacing-regular);--mobile-color:var(--vds-color-element-primary-onlightprimary);--tablet-fontfamily:var(--vds-typography-title-xsmall-fontfamily);--tablet-fontsize:var(--vds-typography-title-xsmall-fontsize);--tablet-fontweight:var(--vds-typography-title-xsmall-fontweight-regular);--tablet-lineheight:var(--vds-typography-title-xsmall-lineheight);--tablet-letterspacing:var(--vds-typography-title-xsmall-letterspacing-regular);--tablet-color:var(--vds-color-element-primary-onlightprimary)" class="VDS__MON__text-module__x-eQN VDS__MON__text-module__cYsoT VDS__MON__text-module__Rbysp VDS__MON__text-module__Npe1j VDS__MON__text-module__3QgCx VDS__MON__text-module__Npe1j VDS__MON__text-module__hZ-lB VDS__MON__text-module__Npe1j VDS__MON__text-module__kmxF6">We provide consumers with choices and internet access when, where and how they want. Our advanced broadband networks and services provide strong platforms for innovation for consumers, for Verizon and for other providers and users throughout the internet. We invest billions every year so that consumers can continue to consume more of the internet content they want.</span>
                                                    </div>
                                                  </div>
                                                </div>
                                                <div class="rich-text_wrapper__C_mKL rich-text_backgroundColor-lightprimary__x2tvq">
                                                  <div style="padding-top:var(--vds-space-undefined);padding-bottom:var(--vds-space-unset)">
                                                    <div class="VDS__MON__button-group-module__1Dbuz" style="width:100%">
                                                      <div class="VDS__MON__button-group-module__NDPr1 VDS__MON__button-group-module__ZpqwL">
                                                        <div class="VDS__MON__button-group-module__opadH">
                                                          <a id="6908fc69bdb8b7596475b46d" __meta="[object Object]" iconposition="right" href="/about/our-company/open-internet/about/our-company/verizon-broadband-commitment/" target="_self" style="width:auto" data-testid="button" class="VDS__MON__button-module__3kKdo VDS__MON__button-module__ypbOe VDS__MON__button-module__hH-Lr" aria-label="Our broadband commitment" role="button" aria-disabled="false" tabindex="0">
                                                            <span class="VDS__MON__button-module__-TTKa VDS__MON__button-module__ypbOe VDS__MON__button-module__hH-Lr" tabindex="-1">Our broadband commitment</span>
                                          ...
                                          <div class="base-block_container__ZFzh0 base-block_lightprimary__TA3S7" id="6908b0b13f3ef53da60671b8" style="width:100%">
                                            <a id="base-block-hidden-anchor-6908b0b13f3ef53da60671b8" tabindex="-1">
                                            </a>
                                            <div class="base-block_contentWrapper__5oAUk navigational-tile-block_container__NCwD_" style="--padding-top-mobile:var(--vds-space-8x);--padding-bottom-mobile:var(--vds-space-8x);--padding-top-tablet:var(--vds-space-12x);--padding-bottom-tablet:var(--vds-space-12x);--padding-top-desktop:var(--vds-space-16x);--padding-bottom-desktop:var(--vds-space-16x);--desktop-content-max-width:1232px">
                                              <div class="navigational-tile-block_title__pQNJK">
                                                <div style="width:100%" class="header-title_outerWrapper___kDOM">
                                                  <div class="header-title_textWrapper__MjGg7" style="--header-textHorizontalAlignment:center;--header-align-items:center">
                                                    <div class="header-title_title__zNZnw" style="--header-title-maxWidth-mobile:328px;--header-title-maxWidth-tablet:550px;--header-title-maxWidth-desktop:800px;--header-title-maxWidth:100%">
                                                      <h2 style="--base-text-color:var(--vds-color-element-primary-onlightprimary);--tablet-fontfamily:var(--vds-typography-title-xlarge-fontfamily);--tablet-fontsize:var(--vds-typography-title-xlarge-fontsize);--tablet-fontweight:var(--vds-typography-title-xlarge-fontweight-bold);--tablet-lineheight:var(--vds-typography-title-xlarge-lineheight);--tablet-letterspacing:var(--vds-typography-title-xlarge-letterspacing-bold);--tablet-color:var(--vds-color-element-primary-onlightprimary);--desktop-fontfamily:var(--vds-typography-title-2xlarge-fontfamily);--desktop-fontsize:var(--vds-typography-title-2xlarge-fontsize);--desktop-fontweight:var(--vds-typography-title-2xlarge-fontweight-bold);--desktop-lineheight:var(--vds-typography-title-2xlarge-lineheight);--desktop-letterspacing:var(--vds-typography-title-2xlarge-letterspacing-bold);--desktop-color:var(--vds-color-element-primary-onlightprimary);--mobile-fontfamily:var(--vds-typography-title-medium-fontfamily);--mobile-fontsize:var(--vds-typography-title-medium-fontsize);--mobile-fontweight:var(--vds-typography-title-medium-fontweight-bold);--mobile-lineheight:var(--vds-typography-title-medium-lineheight);--mobile-letterspacing:var(--vds-typography-title-medium-letterspacing-bold);--mobile-color:var(--vds-color-element-primary-onlightprimary)" class="VDS__MON__text-module__x-eQN VDS__MON__text-module__cYsoT VDS__MON__text-module__Eo6jM VDS__MON__text-module__lEJk4 VDS__MON__text-module__Npe1j VDS__MON__text-module__kmxF6 VDS__MON__text-module__Npe1j VDS__MON__text-module__3QgCx VDS__MON__text-module__Npe1j VDS__MON__text-module__hZ-lB">Our network management &amp; performance practices</h2>
                                                      </div>
                                                    </div>
                                                  </div>
                                                </div>
                                                <div class="navigational-tile-block_content__X0q7l">
                                                  <div class="navigational-tile-block_tiles__inopF">
                                                    <div class="VDS__MON__tilelet-group-module__nZxs0 VDS__MON__tilelet-group-module__qOAxZ" style="width:100%;grid-template-columns:repeat(1, 1fr)">
                                                      <div class="VDS__MON__tilelet-group-module__dvgMr">
                                                        <div data-testid="tilelet-wrapper" style="height:100%;width:100%" class="VDS__MON__interactive-module__C3sjJ VDS__MON__interactive-module__a6FU2">
                                                          <a __meta="[object Object]" data-testid="tilelet-outer-button" class="VDS__MON__interactive-module__-DPZN VDS__MON__interactive-module__sLNp- VDS__MON__interactive-module__-aNU8 VDS__MON__interactive-module__RcHX3 VDS__MON__interactive-module__a6FU2" role="link" aria-label="  Network management In this section we provide information about our network management practices for our wireless, wired and Wi-Fi broadband internet access services." tabindex="0" href="/about/our-company/open-internet/about/our-company/network-management/" target="_self" id="OuterButton-«Rardi7n9nb»">
                                                          </a>
                                                          <div data-testid="tilelet-tile" id="«Rardi7n9nb»" class="VDS__MON__interactive-module__rBfHX VDS__MON__interactive-module__sLNp- VDS__MON__interactive-module__RcHX3 VDS__MON__interactive-module__2-M4t VDS__MON__interactive-module__tHO9U VDS__MON__interactive-module__a6FU2" style="height:100%;width:100%">
                                                            <div data-testid="tile-inner-container-tilelet" id="tile-inner-container-«Rardi7n9nb»" class="VDS__MON__interactive-module__yEh-S">
                                                              <div class="VDS__MON__tilelet-module__OChXj">
                                                                <div class="VDS__MON__tilelet-module__ESqPh" style="gap:var(--vds-space-2x)">
                                                                <div class="VDS__MON__tilelet-module__weD-j" style="width:100%">
                                                                <div class="VDS__MON__tilelet-module__OOpaV VDS__MON__tilelet-module__GOjhK">
                                                                <div class="VDS__MON__title-lockup-module__OVlJt">
                                                                <div class="VDS__MON__title-lockup-title-module__LKmdl VDS__MON__title-lockup-title-module__IKV1S" data-testid="title-wrapper">
                                                                <span class="VDS__MON__title-lockup-title-module__zqvkE VDS__MON__title-lockup-title-module__Cjx-y" style="color: var(--vds-color-element-primary-onlightbrandneutral); overflow: visible; text-overflow: unset; height: auto;" data-testid="title">Network management</span>
                                                              </div>
                                                              <div class="VDS__MON__title-lockup-subtitle-module__7TYdl" data-testid="subtitle-wrapper">
                                                                <span class="VDS__MON__title-lockup-subtitle-module__l70IL VDS__MON__title-lockup-subtitle-module__CvDfQ" style="color: var(--vds-color-element-primary-onlightbrandneutral); overflow: visible; text-overflow: unset; height: auto;" data-testid="subtitle">In this section we provide information about our network management practices for our wireless, wired and Wi-Fi broadband internet access services.</span>
                                                              </div>
                                                            </div>
                                                          </div>
                                                        </div>
                                                      </div>
                                                      <div class="VDS__MON__tilelet-module__R3rPV VDS__MON__tilelet-module__cE6kj VDS__MON__tilelet-module__GtpvG" data-testid="tilelet-icon-container" aria-hidden="true">
                                                        <span class="VDS__MON__tilelet-module__kTdD1" data-testid="tilelet-directional-icon">
                                                          <svg class="VDS__MON__icon-base-module__DAtvV " style="color:var(--vds-color-element-primary-onlightbrandneutral)" role="img" aria-hidden="false" aria-label="right-arrow icon" viewBox="0 0 21.6 21.6" fill="var(--vds-color-element-primary-onlightbrandneutral)"><title>right-arrow icon</title> <path d="M10.71933,19.8l-.817-.80985,7.683-7.61765H1.8v-1.145H17.58533l-7.683-7.61765.817-.80985L19.8,10.8Z"> </path></svg>
                                                        </span>
                                                      </div>
                                                    </div>
                                                  </div>
                                            ...
                                            <div class="VDS__MON__tilelet-group-module__dvgMr">
                                              <div data-testid="tilelet-wrapper" style="height:100%;width:100%" class="VDS__MON__interactive-module__C3sjJ VDS__MON__interactive-module__a6FU2">
                                                ...
                                                <div data-testid="tilelet-tile" id="«Rcrdi7n9nb»" class="VDS__MON__interactive-module__rBfHX VDS__MON__interactive-module__sLNp- VDS__MON__interactive-module__RcHX3 VDS__MON__interactive-module__2-M4t VDS__MON__interactive-module__tHO9U VDS__MON__interactive-module__a6FU2" style="height:100%;width:100%">
                                                  <div data-testid="tile-inner-container-tilelet" id="tile-inner-container-«Rcrdi7n9nb»" class="VDS__MON__interactive-module__yEh-S">
                                                    <div class="VDS__MON__tilelet-module__OChXj">
                                                      <div class="VDS__MON__tilelet-module__ESqPh" style="gap:var(--vds-space-2x)">
                                                        <div class="VDS__MON__tilelet-module__weD-j" style="width:100%">
                                                          <div class="VDS__MON__tilelet-module__OOpaV VDS__MON__tilelet-module__GOjhK">
                                                            <div class="VDS__MON__title-lockup-module__OVlJt">
                                                              <div class="VDS__MON__title-lockup-title-module__LKmdl VDS__MON__title-lockup-title-module__IKV1S" data-testid="title-wrapper">
                                                                <span class="VDS__MON__title-lockup-title-module__zqvkE VDS__MON__title-lockup-title-module__Cjx-y" style="color: var(--vds-color-element-primary-onlightbrandneutral); overflow: visible; text-overflow: unset; height: auto;" data-testid="title">Network performance</span>
                                                              </div>
                                                              <div class="VDS__MON__title-lockup-subtitle-module__7TYdl" data-testid="subtitle-wrapper">
                                                                <span class="VDS__MON__title-lockup-subtitle-module__l70IL VDS__MON__title-lockup-subtitle-module__CvDfQ" style="color: var(--vds-color-element-primary-onlightbrandneutral); overflow: visible; text-overflow: unset; height: auto;" data-testid="subtitle">View the performance you can expect to receive based on our internal testing, our testing commissioned from third-party vendors, and results from the latest government studies.</span>
                                                              </div>
                                                            </div>
                                                          </div>
                                                        </div>
                                        ...
                                        <div class="navigational-tile-block_image__XT6BH" aria-hidden="false">
                                          <div class="image_imageContainer__3nvQM" style="aspect-ratio: 1 / 1; border-radius: var(--vds-tiles-border-radius-standard);">
                                            <picture>
                                              <source type="image/webp" srcset="assets/ss7.vzw.com/is/image/VerizonWireless/Open-internet_Network-Management-1-1%20(1)?resMode=sharp2&amp;scl=1&amp;fmt=webp">
                                              <source type="image/avif" srcset="assets/ss7.vzw.com/is/image/VerizonWireless/Open-internet_Network-Management-1-1%20(1)?resMode=sharp2&amp;scl=1&amp;fmt=avif">
                                              <img class="image_image__sPkwR " src="assets/ss7.vzw.com/is/image/VerizonWireless/Open-internet_Network-Management-1-1%20(1)/?resMode=sharp2&amp;scl=1" alt="A tall telecommunications tower with antennas overlooking a river and city skyline." style="border-radius:var(--vds-tiles-border-radius-standard)">
                                            </picture>
                                          </div>
                                        </div>
                                      </div>
                                  ...
                                  <div class="base-block_container__ZFzh0 base-block_lightprimary__TA3S7" id="6904c5527c099040ae96aa2b" style="width:100%">
                                    <a id="base-block-hidden-anchor-6904c5527c099040ae96aa2b" tabindex="-1">
                                    </a>
                                    <div class="base-block_contentWrapper__5oAUk navigational-list-block_container__5Hydn navigational-list-block_bottom__NvuiD navigational-list-block_noImage__GcvTD" style="--padding-top-mobile:var(--vds-space-8x);--padding-bottom-mobile:var(--vds-space-12x);--padding-top-tablet:var(--vds-space-12x);--padding-bottom-tablet:var(--vds-space-16x);--padding-top-desktop:var(--vds-space-16x);--padding-bottom-desktop:var(--vds-space-24x);--desktop-content-max-width:1232px">
                                      <div class="navigational-list-block_textContent__PuTpo navigational-list-block_bottom__NvuiD navigational-list-block_noImage__GcvTD navigational-list-block_bottom__NvuiD">
                                        <div style="width:100%" class="header-title_outerWrapper___kDOM">
                                          <div class="header-title_textWrapper__MjGg7" style="--header-textHorizontalAlignment:center;--header-align-items:center">
                                            <div class="header-title_title__zNZnw" style="--header-title-maxWidth:100%">
                                              <h2 style="--base-text-color:var(--vds-color-element-primary-onlightprimary);--tablet-fontfamily:var(--vds-typography-title-xlarge-fontfamily);--tablet-fontsize:var(--vds-typography-title-xlarge-fontsize);--tablet-fontweight:var(--vds-typography-title-xlarge-fontweight-bold);--tablet-lineheight:var(--vds-typography-title-xlarge-lineheight);--tablet-letterspacing:var(--vds-typography-title-xlarge-letterspacing-bold);--tablet-color:var(--vds-color-element-primary-onlightprimary);--desktop-fontfamily:var(--vds-typography-title-2xlarge-fontfamily);--desktop-fontsize:var(--vds-typography-title-2xlarge-fontsize);--desktop-fontweight:var(--vds-typography-title-2xlarge-fontweight-bold);--desktop-lineheight:var(--vds-typography-title-2xlarge-lineheight);--desktop-letterspacing:var(--vds-typography-title-2xlarge-letterspacing-bold);--desktop-color:var(--vds-color-element-primary-onlightprimary)" class="VDS__MON__text-module__x-eQN VDS__MON__text-module__cYsoT VDS__MON__text-module__Eo6jM VDS__MON__text-module__lEJk4 VDS__MON__text-module__Npe1j VDS__MON__text-module__kmxF6 VDS__MON__text-module__Npe1j VDS__MON__text-module__3QgCx">Plans &amp; pricing</h2>
                                              </div>
                                              <div class="header-title_subtitle__ym7Pb" style="--header-subtitle-maxWidth-tablet:550px;--header-subtitle-maxWidth-desktop:688px;--header-subtitle-maxWidth:100%">
                                                <span style="--base-text-color:var(--vds-color-element-primary-onlightprimary);--desktop-fontfamily:var(--vds-typography-title-small-fontfamily);--desktop-fontsize:var(--vds-typography-title-small-fontsize);--desktop-fontweight:var(--vds-typography-title-small-fontweight-regular);--desktop-lineheight:var(--vds-typography-title-small-lineheight);--desktop-letterspacing:var(--vds-typography-title-small-letterspacing-regular);--desktop-color:var(--vds-color-element-primary-onlightprimary);--tablet-fontfamily:var(--vds-typography-title-xsmall-fontfamily);--tablet-fontsize:var(--vds-typography-title-xsmall-fontsize);--tablet-fontweight:var(--vds-typography-title-xsmall-fontweight-regular);--tablet-lineheight:var(--vds-typography-title-xsmall-lineheight);--tablet-letterspacing:var(--vds-typography-title-xsmall-letterspacing-regular);--tablet-color:var(--vds-color-element-primary-onlightprimary)" class="VDS__MON__text-module__x-eQN VDS__MON__text-module__cYsoT VDS__MON__text-module__Rbysp VDS__MON__text-module__Npe1j VDS__MON__text-module__3QgCx VDS__MON__text-module__Npe1j VDS__MON__text-module__kmxF6">Verizon offers competitive rates and pricing plans as well as broadband facts labels to help customers find the service that meets their needs and budget.</span>
                                                </div>
                                              </div>
                                            </div>
                                            <div class="list-group_listGroup__bRb6o navigational-list-block_listGroup__9_O1i navigational-list-block_horizontal__r4cjh navigational-list-block_lightprimary___HyjU">
                                              <div class="VDS__MON__list-group-module__MQ02s VDS__MON__list-group-module__YNjqt VDS__MON__list-group-module__g3Ld3 " data-testid="ListGroup">
                                                <div class="VDS__MON__list-group-item-module__rjQID VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__PZ0q2 " id="6904c55203d7a70002eeb756">
                                                  <div data-testid="list-group-item" class="VDS__MON__list-group-item-module__SFwYj VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__Fwq1d VDS__MON__list-group-item-module__AP2Wp">
                                                    ...
                                                    <div class="VDS__MON__list-group-item-module__GG1bz VDS__MON__list-group-item-module__gD7aV" style="margin-left: 0px;">
                                                      <p class="VDS__MON__list-group-item-text-module__EkaPX VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">Broadband facts labels</p>
                                                  ...
                                                  <div class="VDS__MON__list-group-item-module__rjQID VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__PZ0q2 " id="6904c55203d7a70002eeb757">
                                                    <div data-testid="list-group-item" class="VDS__MON__list-group-item-module__SFwYj VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__Fwq1d VDS__MON__list-group-item-module__AP2Wp">
                                                      <button tabindex="-1" class="VDS__MON__list-group-item-module__WeaTM" aria-hidden="true">
                                                      </button>
                                                      <div class="VDS__MON__list-group-item-module__GG1bz VDS__MON__list-group-item-module__gD7aV" style="margin-left: 0px;">
                                                        <p class="VDS__MON__list-group-item-text-module__EkaPX VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">Important plan information (Verizon Wireless)</p>
                                                          <p class="VDS__MON__list-group-item-text-module__xoIjn VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">
                                                          </p>
                                                        </div>
                                                        <div class="VDS__MON__list-group-item-module__o5j3x">
                                                          <div class="VDS__MON__list-group-item-module__SbOBU VDS__MON__list-group-item-module__Kl1vd primary-action-wrapper" id="actionIconSpan">
                                                            <span class="VDS__MON__icon-button-module__4c71Y" style="height: auto; width: auto; --ghost-fit-icon: 1.75rem;">
                                                              <button aria-hidden="false" type="button" class="VDS__MON__icon-button-module__pkRRU VDS__MON__icon-button-module__CqUzT VDS__MON__icon-button-module__V2sdm  VDS__MON__icon-button-module__aSMye    VDS__MON__icon-button-module__Jf6jp" data-testid="list-group-item-iconButton" role="button" aria-label="Important plan information (Verizon Wireless)" aria-disabled="false" tabindex="0">
                                                                <span class="VDS__MON__icon-button-module__xDEgX">
                                                              </span>
                                                              <span class="VDS__MON__icon-button-module__fpD9y">
                                                                <svg class="VDS__MON__icon-base-module__DAtvV " role="img" aria-hidden="true" aria-label="right-arrow icon" viewBox="0 0 21.6 21.6" fill="var(--vds-color-element-primary-onlightprimary)"><path d="M10.71933,19.8l-.817-.80985,7.683-7.61765H1.8v-1.145H17.58533l-7.683-7.61765.817-.80985L19.8,10.8Z"> </path></svg>
                                                  ...
                                                  <div class="VDS__MON__list-group-item-module__rjQID VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__PZ0q2 " id="6904c55203d7a70002eeb758">
                                                    <div data-testid="list-group-item" class="VDS__MON__list-group-item-module__SFwYj VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__Fwq1d VDS__MON__list-group-item-module__AP2Wp">
                                                      <button tabindex="-1" class="VDS__MON__list-group-item-module__WeaTM" aria-hidden="true">
                                                      </button>
                                                      <div class="VDS__MON__list-group-item-module__GG1bz VDS__MON__list-group-item-module__gD7aV" style="margin-left: 0px;">
                                                        <p class="VDS__MON__list-group-item-text-module__EkaPX VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">Verizon Wireless plans &amp; pricing</p>
                                                          <p class="VDS__MON__list-group-item-text-module__xoIjn VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">
                                                          </p>
                                                        </div>
                                                        <div class="VDS__MON__list-group-item-module__o5j3x">
                                                  ...
                                                  <div class="VDS__MON__list-group-item-module__rjQID VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__PZ0q2 " id="6904c55203d7a70002eeb759">
                                                    <div data-testid="list-group-item" class="VDS__MON__list-group-item-module__SFwYj VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__Fwq1d VDS__MON__list-group-item-module__AP2Wp">
                                                      <button tabindex="-1" class="VDS__MON__list-group-item-module__WeaTM" aria-hidden="true">
                                                      </button>
                                                      <div class="VDS__MON__list-group-item-module__GG1bz VDS__MON__list-group-item-module__gD7aV" style="margin-left: 0px;">
                                                        <p class="VDS__MON__list-group-item-text-module__EkaPX VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">Verizon Fios pricing (residential)</p>
                                                          <p class="VDS__MON__list-group-item-text-module__xoIjn VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">
                                                          </p>
                                                        </div>
                                                        <div class="VDS__MON__list-group-item-module__o5j3x">
                                                          <div class="VDS__MON__list-group-item-module__SbOBU VDS__MON__list-group-item-module__Kl1vd primary-action-wrapper" id="actionIconSpan">
                                                            <span class="VDS__MON__icon-button-module__4c71Y" style="height: auto; width: auto; --ghost-fit-icon: 1.75rem;">
                                                              <button aria-hidden="false" type="button" class="VDS__MON__icon-button-module__pkRRU VDS__MON__icon-button-module__CqUzT VDS__MON__icon-button-module__V2sdm  VDS__MON__icon-button-module__aSMye    VDS__MON__icon-button-module__Jf6jp" data-testid="list-group-item-iconButton" role="button" aria-label="Verizon Fios pricing (residential)" aria-disabled="false" tabindex="0">
                                                                <span class="VDS__MON__icon-button-module__xDEgX">
                                                              </span>
                                                              <span class="VDS__MON__icon-button-module__fpD9y">
                                                                <svg class="VDS__MON__icon-base-module__DAtvV " role="img" aria-hidden="true" aria-label="right-arrow icon" viewBox="0 0 21.6 21.6" fill="var(--vds-color-element-primary-onlightprimary)"><path d="M10.71933,19.8l-.817-.80985,7.683-7.61765H1.8v-1.145H17.58533l-7.683-7.61765.817-.80985L19.8,10.8Z"> </path></svg>
                                                  ...
                                                  <div class="VDS__MON__list-group-item-module__rjQID VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__PZ0q2 " id="6904d0137c099040ae96aa2e">
                                                    <div data-testid="list-group-item" class="VDS__MON__list-group-item-module__SFwYj VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__Fwq1d VDS__MON__list-group-item-module__AP2Wp">
                                                      <button tabindex="-1" class="VDS__MON__list-group-item-module__WeaTM" aria-hidden="true">
                                                      </button>
                                                      <div class="VDS__MON__list-group-item-module__GG1bz VDS__MON__list-group-item-module__gD7aV" style="margin-left: 0px;">
                                                        <p class="VDS__MON__list-group-item-text-module__EkaPX VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">Verizon DSL pricing (residential)</p>
                                                          <p class="VDS__MON__list-group-item-text-module__xoIjn VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">
                                                          </p>
                                                        </div>
                                                        <div class="VDS__MON__list-group-item-module__o5j3x">
                                                          <div class="VDS__MON__list-group-item-module__SbOBU VDS__MON__list-group-item-module__Kl1vd primary-action-wrapper" id="actionIconSpan">
                                                            <span class="VDS__MON__icon-button-module__4c71Y" style="height: auto; width: auto; --ghost-fit-icon: 1.75rem;">
                                                              <button aria-hidden="false" type="button" class="VDS__MON__icon-button-module__pkRRU VDS__MON__icon-button-module__CqUzT VDS__MON__icon-button-module__V2sdm  VDS__MON__icon-button-module__aSMye    VDS__MON__icon-button-module__Jf6jp" data-testid="list-group-item-iconButton" role="button" aria-label="Verizon DSL pricing (residential)" aria-disabled="false" tabindex="0">
                                                                <span class="VDS__MON__icon-button-module__xDEgX">
                                                              </span>
                                                              <span class="VDS__MON__icon-button-module__fpD9y">
                                                                <svg class="VDS__MON__icon-base-module__DAtvV " role="img" aria-hidden="true" aria-label="right-arrow icon" viewBox="0 0 21.6 21.6" fill="var(--vds-color-element-primary-onlightprimary)"><path d="M10.71933,19.8l-.817-.80985,7.683-7.61765H1.8v-1.145H17.58533l-7.683-7.61765.817-.80985L19.8,10.8Z"> </path></svg>
                                                  ...
                                                  <div class="VDS__MON__list-group-item-module__rjQID VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__PZ0q2 " id="6904d02a7c099040ae96aa31">
                                                    <div data-testid="list-group-item" class="VDS__MON__list-group-item-module__SFwYj VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__Fwq1d VDS__MON__list-group-item-module__AP2Wp">
                                                      <button tabindex="-1" class="VDS__MON__list-group-item-module__WeaTM" aria-hidden="true">
                                                      </button>
                                                      <div class="VDS__MON__list-group-item-module__GG1bz VDS__MON__list-group-item-module__gD7aV" style="margin-left: 0px;">
                                                        <p class="VDS__MON__list-group-item-text-module__EkaPX VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">Verizon Business Internet</p>
                                                          <p class="VDS__MON__list-group-item-text-module__xoIjn VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">
                                                          </p>
                                                        </div>
                                                        <div class="VDS__MON__list-group-item-module__o5j3x">
                                                          <div class="VDS__MON__list-group-item-module__SbOBU VDS__MON__list-group-item-module__Kl1vd primary-action-wrapper" id="actionIconSpan">
                                                            <span class="VDS__MON__icon-button-module__4c71Y" style="height: auto; width: auto; --ghost-fit-icon: 1.75rem;">
                                                              <button aria-hidden="false" type="button" class="VDS__MON__icon-button-module__pkRRU VDS__MON__icon-button-module__CqUzT VDS__MON__icon-button-module__V2sdm  VDS__MON__icon-button-module__aSMye    VDS__MON__icon-button-module__Jf6jp" data-testid="list-group-item-iconButton" role="button" aria-label="Verizon Business Internet" aria-disabled="false" tabindex="0">
                                                                <span class="VDS__MON__icon-button-module__xDEgX">
                                                              </span>
                                                              <span class="VDS__MON__icon-button-module__fpD9y">
                                                                <svg class="VDS__MON__icon-base-module__DAtvV " role="img" aria-hidden="true" aria-label="right-arrow icon" viewBox="0 0 21.6 21.6" fill="var(--vds-color-element-primary-onlightprimary)"><path d="M10.71933,19.8l-.817-.80985,7.683-7.61765H1.8v-1.145H17.58533l-7.683-7.61765.817-.80985L19.8,10.8Z"> </path></svg>
                                                  ...
                                                  <div class="VDS__MON__list-group-item-module__rjQID VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__PZ0q2 " id="6904d0427c099040ae96aa34">
                                                    <div data-testid="list-group-item" class="VDS__MON__list-group-item-module__SFwYj VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__Fwq1d VDS__MON__list-group-item-module__AP2Wp">
                                                      <button tabindex="-1" class="VDS__MON__list-group-item-module__WeaTM" aria-hidden="true">
                                                      </button>
                                                      <div class="VDS__MON__list-group-item-module__GG1bz VDS__MON__list-group-item-module__gD7aV" style="margin-left: 0px;">
                                                        <p class="VDS__MON__list-group-item-text-module__EkaPX VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">Verizon Wireless Business</p>
                                                          <p class="VDS__MON__list-group-item-text-module__xoIjn VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">
                                                          </p>
                                                        </div>
                                                        <div class="VDS__MON__list-group-item-module__o5j3x">
                                                          <div class="VDS__MON__list-group-item-module__SbOBU VDS__MON__list-group-item-module__Kl1vd primary-action-wrapper" id="actionIconSpan">
                                                            <span class="VDS__MON__icon-button-module__4c71Y" style="height: auto; width: auto; --ghost-fit-icon: 1.75rem;">
                                                              <button aria-hidden="false" type="button" class="VDS__MON__icon-button-module__pkRRU VDS__MON__icon-button-module__CqUzT VDS__MON__icon-button-module__V2sdm  VDS__MON__icon-button-module__aSMye    VDS__MON__icon-button-module__Jf6jp" data-testid="list-group-item-iconButton" role="button" aria-label="Verizon Wireless Business" aria-disabled="false" tabindex="0">
                                                                <span class="VDS__MON__icon-button-module__xDEgX">
                                                              </span>
                                                              <span class="VDS__MON__icon-button-module__fpD9y">
                                                                <svg class="VDS__MON__icon-base-module__DAtvV " role="img" aria-hidden="true" aria-label="right-arrow icon" viewBox="0 0 21.6 21.6" fill="var(--vds-color-element-primary-onlightprimary)"><path d="M10.71933,19.8l-.817-.80985,7.683-7.61765H1.8v-1.145H17.58533l-7.683-7.61765.817-.80985L19.8,10.8Z"> </path></svg>
                                                  ...
                                                  <div class="VDS__MON__list-group-item-module__rjQID VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__PZ0q2 " id="6904d0507c099040ae96aa37">
                                                    <div data-testid="list-group-item" class="VDS__MON__list-group-item-module__SFwYj VDS__MON__list-group-item-module__Kl1vd VDS__MON__list-group-item-module__Fwq1d VDS__MON__list-group-item-module__AP2Wp">
                                                      <button tabindex="-1" class="VDS__MON__list-group-item-module__WeaTM" aria-hidden="true">
                                                      </button>
                                                      <div class="VDS__MON__list-group-item-module__GG1bz VDS__MON__list-group-item-module__gD7aV" style="margin-left: 0px;">
                                                        <p class="VDS__MON__list-group-item-text-module__EkaPX VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">mbrace pricing</p>
                                                          <p class="VDS__MON__list-group-item-text-module__xoIjn VDS__MON__list-group-item-text-module__VIIXb VDS__MON__list-group-item-text-module__0gQaA">
                                                          </p>
                                                        </div>
                                                        <div class="VDS__MON__list-group-item-module__o5j3x">
                                                          <div class="VDS__MON__list-group-item-module__SbOBU VDS__MON__list-group-item-module__Kl1vd primary-action-wrapper" id="actionIconSpan">
                                                            <span class="VDS__MON__icon-button-module__4c71Y" style="height: auto; width: auto; --ghost-fit-icon: 1.75rem;">
                                                              <button aria-hidden="false" type="button" class="VDS__MON__icon-button-module__pkRRU VDS__MON__icon-button-module__CqUzT VDS__MON__icon-button-module__V2sdm  VDS__MON__icon-button-module__aSMye    VDS__MON__icon-button-module__Jf6jp" data-testid="list-group-item-iconButton" role="button" aria-label="mbrace pricing" aria-disabled="false" tabindex="0">
                                                                <span class="VDS__MON__icon-button-module__xDEgX">
                                                              </span>
                                                              <span class="VDS__MON__icon-button-module__fpD9y">
                                                                <svg class="VDS__MON__icon-base-module__DAtvV " role="img" aria-hidden="true" aria-label="right-arrow icon" viewBox="0 0 21.6 21.6" fill="var(--vds-color-element-primary-onlightprimary)"><path d="M10.71933,19.8l-.817-.80985,7.683-7.61765H1.8v-1.145H17.58533l-7.683-7.61765.817-.80985L19.8,10.8Z"> </path></svg>
                                        ...
                                        <div class="base-block_container__ZFzh0 base-block_lightbrandneutral__ltTHw" id="6904c5587c099040ae96aa2c" style="width:100%">
                                          <a id="base-block-hidden-anchor-6904c5587c099040ae96aa2c" tabindex="-1">
                                          </a>
                                          <div class="base-block_contentWrapper__5oAUk navigational-grid-block_container__iuby7" style="--padding-top-mobile:var(--vds-space-12x);--padding-right-mobile:var(--vds-space-4x);--padding-bottom-mobile:var(--vds-space-12x);--padding-left-mobile:var(--vds-space-4x);--padding-top-tablet:var(--vds-space-16x);--padding-right-tablet:var(--vds-space-6x);--padding-bottom-tablet:var(--vds-space-16x);--padding-left-tablet:var(--vds-space-6x);--padding-top-desktop:var(--vds-space-24x);--padding-right-desktop:var(--vds-space-6x);--padding-bottom-desktop:var(--vds-space-24x);--padding-left-desktop:var(--vds-space-6x);--desktop-content-max-width:1232px">
                                            <div class="navigational-grid-block_contentContainer__DwXuV navigational-grid-block_horizontalOrientation__5bFn5 navigational-grid-block_verticalCenter__yM_mH">
                                              <div class="navigational-grid-block_headerWrapper__HJuOr" style="--header-width:50%">
                                                <div style="width:100%" class="header-title_outerWrapper___kDOM">
                                                  <div class="header-title_textWrapper__MjGg7" style="--header-textHorizontalAlignment:left;--header-align-items:flex-start">
                                                    <div class="header-title_title__zNZnw" style="--header-title-maxWidth:100%">
                                                      <h2 style="--base-text-color:var(--vds-color-element-primary-onlightbrandneutral);--tablet-fontfamily:var(--vds-typography-title-xlarge-fontfamily);--tablet-fontsize:var(--vds-typography-title-xlarge-fontsize);--tablet-fontweight:var(--vds-typography-title-xlarge-fontweight-bold);--tablet-lineheight:var(--vds-typography-title-xlarge-lineheight);--tablet-letterspacing:var(--vds-typography-title-xlarge-letterspacing-bold);--tablet-color:var(--vds-color-element-primary-onlightbrandneutral);--desktop-fontfamily:var(--vds-typography-title-2xlarge-fontfamily);--desktop-fontsize:var(--vds-typography-title-2xlarge-fontsize);--desktop-fontweight:var(--vds-typography-title-2xlarge-fontweight-bold);--desktop-lineheight:var(--vds-typography-title-2xlarge-lineheight);--desktop-letterspacing:var(--vds-typography-title-2xlarge-letterspacing-bold);--desktop-color:var(--vds-color-element-primary-onlightbrandneutral)" class="VDS__MON__text-module__x-eQN VDS__MON__text-module__cYsoT VDS__MON__text-module__Eo6jM VDS__MON__text-module__lEJk4 VDS__MON__text-module__Npe1j VDS__MON__text-module__kmxF6 VDS__MON__text-module__Npe1j VDS__MON__text-module__3QgCx">Related resources</h2>
                                                      </div>
                                                    </div>
                                                  </div>
                                                </div>
                                                <div class="navigational-grid-block_tilesWrapper__qOF8M" style="--min-width:278px">
                                                  <div class="VDS__MON__tilelet-group-module__nZxs0 VDS__MON__tilelet-group-module__qOAxZ" style="width:50%;grid-template-columns:repeat(2, 1fr)">
                                                    <div class="VDS__MON__tilelet-group-module__dvgMr">
                                                      <div data-testid="tilelet-wrapper" style="height:100%;width:100%" class="VDS__MON__interactive-module__C3sjJ VDS__MON__interactive-module__a6FU2">
                                                        <a __meta="[object Object]" data-testid="tilelet-outer-button" class="VDS__MON__interactive-module__-DPZN VDS__MON__interactive-module__sLNp- VDS__MON__interactive-module__-aNU8 VDS__MON__interactive-module__eTWmd VDS__MON__interactive-module__a6FU2" role="link" aria-label="  Verizon value brands " tabindex="0" href="/about/our-company/open-internet/support/tracfone-open-internet-legal/" target="_self" id="OuterButton-«R4rli7n9nb»">
                                                        </a>
                                                        <div data-testid="tilelet-tile" id="«R4rli7n9nb»" class="VDS__MON__interactive-module__rBfHX VDS__MON__interactive-module__sLNp- VDS__MON__interactive-module__eTWmd VDS__MON__interactive-module__Ue9ri VDS__MON__interactive-module__tHO9U VDS__MON__interactive-module__a6FU2" style="height:100%;width:100%">
                                                          <div data-testid="tile-inner-container-tilelet" id="tile-inner-container-«R4rli7n9nb»" class="VDS__MON__interactive-module__yEh-S">
                                                            <div class="VDS__MON__tilelet-module__OChXj">
                                                              <div class="VDS__MON__tilelet-module__ESqPh" style="gap:var(--vds-space-2x)">
                                                                <div class="VDS__MON__tilelet-module__weD-j" style="width:100%">
                                                                <div class="VDS__MON__tilelet-module__OOpaV VDS__MON__tilelet-module__GOjhK">
                                                                <div class="VDS__MON__title-lockup-module__OVlJt">
                                                                <div class="VDS__MON__title-lockup-title-module__LKmdl VDS__MON__title-lockup-title-module__Lznib VDS__MON__title-lockup-title-module__IKV1S" data-testid="title-wrapper">
                                                                <p class="VDS__MON__title-lockup-title-module__zqvkE VDS__MON__title-lockup-title-module__Cjx-y" style="color: var(--vds-color-element-primary-onlightbrandneutral); overflow: visible; text-overflow: unset; height: auto;" data-testid="title">Verizon value brands</p>
                                                              </div>
                                                            </div>
                                                          </div>
                                                        </div>
                                            ...
                                            <div class="VDS__MON__tilelet-group-module__dvgMr">
                                              <div data-testid="tilelet-wrapper" style="height:100%;width:100%" class="VDS__MON__interactive-module__C3sjJ VDS__MON__interactive-module__a6FU2">
                                                <a __meta="[object Object]" data-testid="tilelet-outer-button" class="VDS__MON__interactive-module__-DPZN VDS__MON__interactive-module__sLNp- VDS__MON__interactive-module__-aNU8 VDS__MON__interactive-module__eTWmd VDS__MON__interactive-module__a6FU2" role="link" aria-label="  Terms &amp; conditions " tabindex="0" href="/about/our-company/open-internet/about/terms-conditions/overview/" target="_self" id="OuterButton-«R5bli7n9nb»">
                                                </a>
                                                <div data-testid="tilelet-tile" id="«R5bli7n9nb»" class="VDS__MON__interactive-module__rBfHX VDS__MON__interactive-module__sLNp- VDS__MON__interactive-module__eTWmd VDS__MON__interactive-module__Ue9ri VDS__MON__interactive-module__tHO9U VDS__MON__interactive-module__a6FU2" style="height:100%;width:100%">
                                                  <div data-testid="tile-inner-container-tilelet" id="tile-inner-container-«R5bli7n9nb»" class="VDS__MON__interactive-module__yEh-S">
                                                    <div class="VDS__MON__tilelet-module__OChXj">
                                                      <div class="VDS__MON__tilelet-module__ESqPh" style="gap:var(--vds-space-2x)">
                                                        <div class="VDS__MON__tilelet-module__weD-j" style="width:100%">
                                                          <div class="VDS__MON__tilelet-module__OOpaV VDS__MON__tilelet-module__GOjhK">
                                                            <div class="VDS__MON__title-lockup-module__OVlJt">
                                                              <div class="VDS__MON__title-lockup-title-module__LKmdl VDS__MON__title-lockup-title-module__Lznib VDS__MON__title-lockup-title-module__IKV1S" data-testid="title-wrapper">
                                                                <p class="VDS__MON__title-lockup-title-module__zqvkE VDS__MON__title-lockup-title-module__Cjx-y" style="color: var(--vds-color-element-primary-onlightbrandneutral); overflow: visible; text-overflow: unset; height: auto;" data-testid="title">Terms &amp; conditions</p>
                                                              </div>
                                                            </div>
                                                          </div>
                                                        </div>
                                            ...
                                            <div class="VDS__MON__tilelet-group-module__dvgMr">
                                              <div data-testid="tilelet-wrapper" style="height:100%;width:100%" class="VDS__MON__interactive-module__C3sjJ VDS__MON__interactive-module__a6FU2">
                                                <a __meta="[object Object]" data-testid="tilelet-outer-button" class="VDS__MON__interactive-module__-DPZN VDS__MON__interactive-module__sLNp- VDS__MON__interactive-module__-aNU8 VDS__MON__interactive-module__eTWmd VDS__MON__interactive-module__a6FU2" role="link" aria-label="  Privacy policies " tabindex="0" href="/about/our-company/open-internet/about/privacy/privacy-policy-summary/" target="_self" id="OuterButton-«R5rli7n9nb»">
                                                </a>
                                                <div data-testid="tilelet-tile" id="«R5rli7n9nb»" class="VDS__MON__interactive-module__rBfHX VDS__MON__interactive-module__sLNp- VDS__MON__interactive-module__eTWmd VDS__MON__interactive-module__Ue9ri VDS__MON__interactive-module__tHO9U VDS__MON__interactive-module__a6FU2" style="height:100%;width:100%">
                                                  <div data-testid="tile-inner-container-tilelet" id="tile-inner-container-«R5rli7n9nb»" class="VDS__MON__interactive-module__yEh-S">
                                                    <div class="VDS__MON__tilelet-module__OChXj">
                                                      <div class="VDS__MON__tilelet-module__ESqPh" style="gap:var(--vds-space-2x)">
                                                        <div class="VDS__MON__tilelet-module__weD-j" style="width:100%">
                                                          <div class="VDS__MON__tilelet-module__OOpaV VDS__MON__tilelet-module__GOjhK">
                                                            <div class="VDS__MON__title-lockup-module__OVlJt">
                                                              <div class="VDS__MON__title-lockup-title-module__LKmdl VDS__MON__title-lockup-title-module__Lznib VDS__MON__title-lockup-title-module__IKV1S" data-testid="title-wrapper">
                                                                <p class="VDS__MON__title-lockup-title-module__zqvkE VDS__MON__title-lockup-title-module__Cjx-y" style="color: var(--vds-color-element-primary-onlightbrandneutral); overflow: visible; text-overflow: unset; height: auto;" data-testid="title">Privacy policies</p>
                                                              </div>
                                                            </div>
                                                          </div>
                                                        </div>
                                            ...
                                            <div class="VDS__MON__tilelet-group-module__dvgMr">
                                              <div data-testid="tilelet-wrapper" style="height:100%;width:100%" class="VDS__MON__interactive-module__C3sjJ VDS__MON__interactive-module__a6FU2">
                                                <a __meta="[object Object]" data-testid="tilelet-outer-button" class="VDS__MON__interactive-module__-DPZN VDS__MON__interactive-module__sLNp- VDS__MON__interactive-module__-aNU8 VDS__MON__interactive-module__eTWmd VDS__MON__interactive-module__a6FU2" role="link" aria-label="  Consumer safety " tabindex="0" href="/about/our-company/open-internet/about/consumer-safety/important-consumer-information-safety/important-consumer-information/" target="_self" id="OuterButton-«R6bli7n9nb»">
                                                </a>
                                                <div data-testid="tilelet-tile" id="«R6bli7n9nb»" class="VDS__MON__interactive-module__rBfHX VDS__MON__interactive-module__sLNp- VDS__MON__interactive-module__eTWmd VDS__MON__interactive-module__Ue9ri VDS__MON__interactive-module__tHO9U VDS__MON__interactive-module__a6FU2" style="height:100%;width:100%">
                                                  <div data-testid="tile-inner-container-tilelet" id="tile-inner-container-«R6bli7n9nb»" class="VDS__MON__interactive-module__yEh-S">
                                                    <div class="VDS__MON__tilelet-module__OChXj">
                                                      <div class="VDS__MON__tilelet-module__ESqPh" style="gap:var(--vds-space-2x)">
                                                        <div class="VDS__MON__tilelet-module__weD-j" style="width:100%">
                                                          <div class="VDS__MON__tilelet-module__OOpaV VDS__MON__tilelet-module__GOjhK">
                                                            <div class="VDS__MON__title-lockup-module__OVlJt">
                                                              <div class="VDS__MON__title-lockup-title-module__LKmdl VDS__MON__title-lockup-title-module__Lznib VDS__MON__title-lockup-title-module__IKV1S" data-testid="title-wrapper">
                                                                <p class="VDS__MON__title-lockup-title-module__zqvkE VDS__MON__title-lockup-title-module__Cjx-y" style="color: var(--vds-color-element-primary-onlightbrandneutral); overflow: visible; text-overflow: unset; height: auto;" data-testid="title">Consumer safety</p>
                                                              </div>
                                                            </div>
                                                          </div>
                                                        </div>
